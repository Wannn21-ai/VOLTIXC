...
// Canonical cloud transport identity for VOLTIX V.01.
...
static constexpr const char* TOPIC_COMMAND_ACK = "voltix/device01/command/ack";
static constexpr const char* TOPIC_CONFIG = "voltix/device01/config";
static constexpr const char* TOPIC_CONFIG_STATE = "voltix/device01/config/state";
static constexpr const char* TOPIC_HISTORY = "voltix/device01/history";
static constexpr const char* TOPIC_HISTORY_ACK = "voltix/device01/history/ack";
static constexpr const char* TOPIC_HISTORY_CLEANUP = "voltix/device01/history/cleanup";
static constexpr const char* TOPIC_HISTORY_CLEANUP_ACK = "voltix/device01/history/cleanup/ack";
...
static constexpr size_t MAX_INBOUND_PAYLOAD_BYTES = 2048;
