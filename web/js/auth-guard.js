...
export const LANG = {
  en: {
    ...
    tariffLabel:"Tariff per kWh", thresholdLabel:"Overload Protection",
    thresholdSub:"Warning activates the LED and buzzer. Reaching the overload threshold trips the relay.",
    savePricing:"Save Configuration",
    ...
    aboutTitle:"About VOLTIX", aboutApp:"Application", aboutVer:"Version",
  ...
  id: {
    ...
    tariffLabel:"Tarif per kWh", thresholdLabel:"Proteksi Overload",
    thresholdSub:"Peringatan mengaktifkan LED dan buzzer. Batas overload akan memutus relay.",
    savePricing:"Simpan Konfigurasi",
    ...
    aboutTitle:"Tentang VOLTIX", aboutApp:"Aplikasi", aboutVer:"Versi",
